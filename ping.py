...
win1 = font1.render('YOU WIN1!', True, (255, 255, 255))
win2 = font1.render('YOU WIN2!', True, (180, 0, 0))
...
racket1 = Player(racket_img,30, 200, 4 ,50 , 10)
racket2 = Player(racket_img,470, 200, 4 ,50 , 10)
ball = GameSprite(ball_img, 250,250, 50,50,50)
win_width = 500
win_height = 500
